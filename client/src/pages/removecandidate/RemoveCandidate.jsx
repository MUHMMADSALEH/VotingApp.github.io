...
import styles from './removecandidate.module.css'
...
const AddCandidate = () => {
    ...
    const handleclick=async(e)=>{
       ...
       try{
           const res= await makeRequest.delete(`/vote/remvecandidate/${data}`);
           if(res.data.status){
            setSuccess(true);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.subContainer}>
        ...
        <div className={styles.addContainer}>
         ...
         value={data}
          />
         <button className={styles.btn} onClick={handleclick}>Remove</button>
        </div>
      </div>
    </div>
  )
